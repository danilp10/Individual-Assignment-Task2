...
import static org.example.SparseMatrixCSRMul.CSRMatrix;
...
public class TestSparseMatrixCSRMul {
    ...
    private CSRMatrix csrA;
    private CSRMatrix csrB;
    ...
    public void setup() {
        ...
        // Fill matrices with random values based on sparsity level
        ...
        csrA = SparseMatrixCSRMul.convertToCSR(A);
        csrB = SparseMatrixCSRMul.convertToCSR(B);
    }

    @Benchmark
    public void benchmarkSparseMatrixMult() {
        measure("CSR Matrix Multiplication", () -> csrA.multiply(csrB));
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(TestSparseMatrixCSRMul.class.getSimpleName())
                .build();
